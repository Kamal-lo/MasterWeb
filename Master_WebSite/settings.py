"""
Django settings for Master_WebSite project.
...
SECRET_KEY = 'django-insecure-7bz!(dp5wn5=tmgy0_ulz@ppl!$%f@arpv%+_=aew4ebzh6r7)'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'master',  # Le nom de la base où se trouvent tes tables
        'USER': 'root',
